# Product Roadmap — Narrative Perception Atlas

> 本文档备份于 2026-07-27，记录 v1.0 已完成功能和未来路线规划。

---

## v1.0 — First Public Demo Release（2026-07-27）
...
- 30 个文化透镜：覆盖北美、东亚、欧洲、南亚、中东、非洲、拉美等全球主要文化区域，每个透镜包含核心特质、解读偏好、情感触发点、误解模式
...
内置 10+ 中国文化 IP 结构化知识（哪吒 2、庆余年、黑神话、流浪地球、三体、我不是药神、马斯克、谷爱凌、芭比、我是歌手），包含核心故事、核心冲突、全球评价和热议议题，推理时自动注入上下文
...
- [ ] 中间结果逐步展示优化（分批推理时逐步展示，而非等待全部完成）
- [ ] 报告 TOC 导航条（快速跳转到各 Lens 视角）
- [ ] 更多 Demo Case 扩充（电影 × 历史 × 游戏跨品类覆盖）
- [ ] 报告区域添加操作入口（复制单条评论、导出全文、分享链接）
- [ ] 30 个文化透镜分组显示而非纯文字 chips
- [ ] 页面底部清理开发工具暴露的 Footer 信息
